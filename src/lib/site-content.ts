export const SOCIAL = {
  youtube: "https://youtube.com/@behindthekarats",
  instagram: "https://www.instagram.com/behindthekarats/",
} as const;
...
/** The statement that opens the film cascade, as the episodes rise out of the dark. */
